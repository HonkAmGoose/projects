...
A list of practical projects that anyone can solve in any programming language (See [solutions](https://github.com/HonkAmGoose/python-challenges)). These projects are divided in multiple categories, and each category has its own folder.
